...
public class ClientHandler extends Thread{
    ...
    private AtomicInteger numOfSuggestions = new AtomicInteger();
        ...
        try{
            ...
            while((inputLine = inFromClient.readLine()) != null){
                ...
                if(arr[0].equals("CREATENEWUSER")){
                    ...
                    // TODO An ArrayIndexOutOfBoundsException occurs if user attempts to login with new credentials without registering into database first
                    // The client sends RESPONSE--LOGIN--UNKNOWNUSER
                ...
                } else if (arr[0].equals("PLAYERSUGGESTION")) {
                    System.out.println(GameSession.numPlayers);
                }
            }
